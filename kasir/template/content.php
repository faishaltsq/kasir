        ...
        <div class="d-flex flex-row bd-highlight mb-3">
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <a href='index.php?page=barang'> 
                        <button type="button" class="btn btn-info" >Tabel Barang</button>
                    </a>
                    </div>
                </div>
                <!--/grey-card -->
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href='index.php?page=Kategori'>
                            <button type="button" class="btn btn-info" >Tabel Kategori</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            <h1>
                                <?= number_format($totalKasir) ?>
                            </h1>
                        </center>
                    </div>
                    <div class="card-footer">
                        <a href='index.php?page=kasir'>
                            <button type="button" class="btn btn-info" >Tabel Penjualan</button>    
                        </a>
                    </div>
                </div>
                <!--/grey-card -->
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href='index.php?page=nota'>
                            <button type="button" class="btn btn-info" >Tabel Nota</button>
                        </a>
                    </div>
                </div>
                <!--/grey-card -->
